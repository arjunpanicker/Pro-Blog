...
function blanket_size(popUpDivVar) {
    ...
    var viewportheight, blanket_height, popUpDiv_height;
    ...
    var blanket = document.getElementById('pageLoaderBackdrop');
...
var checkLogin = function () {
    ...
    if (username == "arjun.panicker" && password == "arjun1995*") {
